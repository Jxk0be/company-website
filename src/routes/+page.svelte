...
<div class="text-white w-full h-screen md:h-[70vh] flex flex-col items-center justify-center relative">
    <h1 class="text-3xl z-[2] md:w-[400px] md:max-w-[500px] max-w-[400px] w-3/4">{@html LogoText}</h1>
    ...
    <div class="md:w-[400px] px-[16px] md:px-0 mt-4 z-[2] gap-3 w-full flex justify-between items-center h-[40px]">
        <button on:click={() => awaitNav("/quote")} class="h-full w-1/2 uppercase rounded-md border-slate-100 border-[2px] bg-transparent">Get a free quote</button>
        <a href="#about" class="h-full w-1/2 flex items-center justify-center uppercase rounded-md border-slate-100 border-[2px] bg-transparent">Learn more</a>
    </div>
